...
const ROUTES = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: 'Practice Ready Assessment – BC (PRA‑BC)',
        description:
          'Complete the Practice Ready Assessment – BC (PRA‑BC). This 12‑week supervised clinical placement and orientation assesses your readiness to practise family medicine in the BC health system. A return‑of‑service agreement is required.',
        docs: ['PRA‑BC application', 'Assessment forms', 'Return‑of‑service agreement'],
        fee: '$5,000',
        timeWeeks: '12'
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        // Updated to reflect Ontario’s new Practice Ready Ontario (PRO) pathway
        title: 'Practice Ready Ontario (PRO) assessment',
        description:
          'Complete the Practice Ready Ontario (PRO) assessment. The PRO program is a 12‑week supervised clinical placement that assesses your readiness to practise family medicine in Ontario. After successful completion, you must fulfil a three‑year return‑of‑service agreement in an underserviced community.',
        docs: ['PRO application', 'Assessment forms', 'Return‑of‑service agreement'],
        fee: '$5,000',
        timeWeeks: '12'
      },
      {
        title: 'Apply for full licence',
        description:
          'After completing the Practice Ready Ontario (PRO) assessment and fulfilling your return‑of‑service agreement, apply for a full licence with CPSO and register with the College of Family Physicians of Canada (CFPC).',
        docs: ['PRO assessment report', 'Registration form'],
        fee: '$425',
        timeWeeks: '4'
      }
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      {
        // Updated for Ontario’s Practice Ready Ontario (PRO) pathway
        title: 'Practice Ready Ontario (PRO) assessment',
        description:
          'Complete the Practice Ready Ontario (PRO) assessment. The PRO program is a 12‑week supervised clinical placement that assesses your readiness to practise family medicine in Ontario. After successful completion, you must fulfil a three‑year return‑of‑service agreement in an underserviced community.',
        docs: ['PRO application', 'Assessment forms', 'Return‑of‑service agreement'],
...
// Insert a credential verification step at the beginning of every Canadian route.
// Most Canadian provinces require internationally trained physicians to verify
// their credentials through the Medical Council of Canada’s physiciansapply.ca
// service before applying for licensure【122108588417876†L176-L194】【891865721766585†L138-L146】.
// Ontario is an exception: applicants create a CPSO portal account and upload
// documents directly to the College of Physicians and Surgeons of Ontario
// (CPSO)【357842479249974†L248-L259】【357842479249974†L351-L356】. This helper
// function prepends the appropriate verification step to each route for Canada.
function addCredentialVerificationSteps() {
  ROUTES.forEach(route => {
    if (route.destinationCountry === 'Canada') {
      // Skip if a verification step is already present
      ...
      if (route.destinationProvince === 'Ontario') {
        // Ontario uses CPSO portal instead of physiciansapply.ca
        verificationStep = {
          title: 'Verify credentials with CPSO portal',
          description:
            'Create a CPSO portal account, complete the self‑screening questionnaire and upload your credentials directly to CPSO. You may optionally share any previously verified documents from physiciansapply.ca to avoid duplicate verification.',
          docs: [
            'CPSO portal account',
        ...
        // All other provinces require physiciansapply.ca source verification
        verificationStep = {
          title: 'Verify credentials via physiciansapply.ca',
          description:
            'Create a physiciansapply.ca account and submit your medical credentials for source verification. Once verified, share your physiciansapply.ca file with the medical regulatory authority in your destination province. Start this process early as it can take several weeks.',
          docs: [
      ...
      // Prepend the verification step to the route’s steps array
      route.steps.unshift(verificationStep);
    }
  });
}

// Run credential verification insertion on initial load after all routes have
// been generated. This ensures that dynamically created routes also receive
// the new step.
...
async function checkForUpdates() {
  try {
    ...
    // Also regenerate missing GP routes if applicable
    if (typeof generateMissingGPRoutes === 'function') {
      generateMissingGPRoutes();
    }
    // Insert verification steps for Canadian routes after regeneration
